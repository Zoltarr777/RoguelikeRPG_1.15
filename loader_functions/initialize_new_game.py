...
#from components.status import Normal, Burned
...
from item_functions import cast_confusion, cast_fireball, cast_lightning, heal, cast_sleep, cast_sleep_aura, health_talisman_sacrifice, cast_mind_control, necromancy, recover_mana, cast_magic, shoot_arrow
from components.item import Item
from random import randint
import random

def get_constants():
	window_title = "Roguelike RPG Version 1.15"
